      ...
      <div className="grid items-center grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="lg:w-3/4 ">
          <div className="flex flex-col gap-5 lg:gap-9">
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=richardfadareboluwatife@gmail.com&su=&body=Hi%20Richard,">
          ...
          <div className="flex items-center gap-5 mt-8 lg:mt-16 lg:gap-9">
            ...
            <a href="https://wa.me/2348109427739?text=Hello Richard">
              <IoLogoWhatsapp
                className="bg-[#8b98a5] p-3 rounded-full hover:bg-[#16f2b3] hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                size={48}
              />
