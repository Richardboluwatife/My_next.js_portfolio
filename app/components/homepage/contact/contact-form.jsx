      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="flex flex-col gap-4 mt-6">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-1.5"
              type="text"
              maxLength="100"
              required={true}
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-1"
              maxLength="500"
              name="message"
              required={true}
